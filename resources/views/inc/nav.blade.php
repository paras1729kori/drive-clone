...
<nav class="navbar sticky-top bg-light navbar-expand-lg mb-3" style="border-bottom: 2px solid #08417a;" id="navbar">
    ...
    <div class="collapse navbar-collapse">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link link" href="/folders/2"><i id="icon" class="fa fa-folder fa-lg icon" aria-hidden="true"></i> Important</a>
        </li>
        <li class="nav-item">
          <a class="nav-link link" href="/folders/1"><i id="icon" class="fa fa-folder fa-lg icon" aria-hidden="true"></i> Starred</a>
        </li>
        <li class="nav-item">
